        ...
        private void tlProjectClient_UpdateWorkCompleted(object sender, UpdateWorkCompletedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                if (e.Error != null)
                    ...
                    tlViewModel.ChangeState(ETimelogState.UnexpectedError, ETimelogOperation.UploadWorkunits, ex.Message);
            }
        }
        ...
        private void tlSecurityClient_GetTokenCompleted(object sender, GetTokenCompletedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                if (e.Error != null)
                    ...
                    tlViewModel.ChangeState(ETimelogState.UnexpectedError, ETimelogOperation.Login, ex.Message);                
            }
        }
        ...
        private void tlProjectClient_GetTasksCompleted(object sender, GetTasksAllocatedToEmployeeCompletedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                if (e.Error != null)
                    ...
                    tlViewModel.ChangeState(ETimelogState.UnexpectedError, ETimelogOperation.GetTasks, ex.Message);
            }
        }
    }
}
